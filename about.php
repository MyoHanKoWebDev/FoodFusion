...
<head>
    ...
    <title>Food Fusion - About Us</title>
...
<div id="forgotPasswordModal" class="modal">
    ...
    <section class="about-header">
        ...
        <p>Where Culinary Creativity Meets Home Cooking</p>
    </section>
    ...
    <section class="about-section">
        ...
        <div class="about-content">
            <p>
                At FoodFusion, we believe that cooking is more than just preparing meals—it’s about creating memories, exploring diverse cultures, and sharing your culinary passions with others. 
                Our platform is dedicated to bringing food enthusiasts together to inspire creativity, foster community, and celebrate the art of home cooking.
            </p>
        </div>
    </section>
    ...
    <section class="team-section">
        ...
        <div class="team-members">
            <div class="team-member">
                <img src="images/images4.png" alt="Team Member 1">
                <h3>Jane Doe</h3>
                <p>Founder & Head Chef</p>
            </div>
            <div class="team-member">
                <img src="images/images3.png" alt="Team Member 2">
                <h3>John Smith</h3>
                <p>Community Manager</p>
            </div>
            <div class="team-member">
                <img src="images/images5.png" alt="Team Member 3">
