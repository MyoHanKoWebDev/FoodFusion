                ...
                <ul class="nav-links" >
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-content">
                            <li><a href="recipes.php" ><img src="images/halo-halo (1).png" alt="" class="dropimg">Recipes</a></li>
...
?>
        ...
        <div class="cleftcon">
            <div class="cleft">
                <p class="p1">Food Fusion</p>
                <p class="p2">Put a Smile on Your Stomach</p>
                <a href="#"  class="ordbtn" id="registerBtn">Join Now</a></li>
            </div>          
        </div>
        <?php endif; ?>
